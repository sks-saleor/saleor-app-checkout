...
/** An enumeration. */
export type LanguageCodeEnum = "EN" | "EN_US" | "KM" | "KM_KH";
...
export type Mutation = {
  ...
  /**
   * Create a user avatar. Only for user authenticated. This mutation must be sent as a `multipart` request. More detailed specs of the upload format can be found here: https://github.com/jaydenseric/graphql-multipart-request-spec
   *
   * Requires one of the following permissions: AUTHENTICATED_USER.
   */
...
export type MutationAttributeBulkCreateArgs = {
  attributes: Array<AttributeBulkCreateInput>;
...
export type UpdatePublicMetadataMutation = {
  ...
  updateMetadata?: {
    ...
    item?:
      ...
      | { __typename?: "Channel"; metafields?: Record<string, string> | null }
      ...
      | { __typename?: "Shop"; metafields?: Record<string, string> | null }
...
export type UpdatePrivateMetadataMutation = {
  ...
  updatePrivateMetadata?: {
    ...
    item?:
      ...
      | { __typename?: "Channel"; privateMetafields?: Record<string, string> | null }
      ...
      | { __typename?: "Shop"; privateMetafields?: Record<string, string> | null }
...
export type TransactionFragment = {
  ...
  id: string;
  pspReference: string;
  canceledAmount: { __typename?: "Money"; currency: string; amount: number };
  ...
  events: Array<{ __typename?: "TransactionEvent"; message: string; pspReference: string }>;
};
  ...
  event?:
    ...
    | {
        ...
        transaction?: {
          ...
          canceledAmount: { __typename?: "Money"; amount: number };
  ...
  mutation CreateWebhooks($targetUrl: String, $query: String) {
    webhookCreate(
      input: {
        ...
        targetUrl: $targetUrl
        events: [TRANSACTION_CHARGE_REQUESTED]
        isActive: true
        query: $query
      }
    ) {
